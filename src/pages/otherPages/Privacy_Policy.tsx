		...
		<div className="min-h-[80vh] bg-slate-200 px-4 py-8">
			<div className="mx-auto w-full max-w-2xl">
				...
				<div className="text-center">
					...
					<h1 className="mb-7 text-2xl font-extrabold tracking-wide text-brand-800">
						PRIVACY POLICY
					</h1>
				</div>
				...
				<div className="rounded-2xl bg-white p-5 shadow-soft border border-slate-200">
					<div className="space-y-4 text-[13px] leading-relaxed text-slate-800">
						<section>
							...
							<div className="mt-1">
								...
								<ul className="mt-1 list-disc pl-5">
									<li>Income and tax-related inputs (for calculation only)</li>
						...
						<section>
							<div className="font-semibold text-brand-800">6. Contact Us</div>
							<div>
